    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/article/edit')}}"><i class="fa fa-plus"></i>修改文章</a>
    ...
    <div class="result_wrap">
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="art_title" size="30" value="{{$field->art_title}}">
                    ...
                    <tr>
                        <th>文章关键词：</th>
                        <td>
                            <input type="text" size="70" name="art_tag" value="{{$field->art_tag}}">
        ...
        //                                    alert(data);
                    ...
                    <tr>
                        <th>文章描述：</th>
                        <td>
                            <textarea class="lg" name="art_description" value="">{{$field->art_description}}</textarea>
