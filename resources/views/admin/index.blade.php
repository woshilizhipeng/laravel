	...
	<div class="menu_box">
		<ul>
            <li>
                ...
                <ul class="sub_menu">
                    <li><a href="{{url('admin/category')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>全部分类</a></li>
            ...
            <li>
                ...
                <ul class="sub_menu">
                    ...
                    <li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-automobile"></i>自定义导航</a></li>
